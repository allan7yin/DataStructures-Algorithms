...
/*
- Let's do a 2 iteration approach. First time, remove ) that are invalid, second time, remove ( that are invalid 
- Second iteration, we add into a string where the index is valid 
*/
impl Solution {
